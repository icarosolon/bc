  ...
  $("#search_article").submit(function(e){
    ...
    if(valor != ''){ 
      ...
      req.onreadystatechange = function() {
        ...
        if(req.readyState == 1) {
          document.getElementById('resultadoPesquisa').innerHTML = '<div id="preloader"><span></span><span></span></div>';
        }
